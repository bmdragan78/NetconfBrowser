...
//	        Path templateFile = SchemaAPI.getPathFromResources(templatesFolder + "/" + defaultTemplate + SchemaSrv.YANG_EXT);
		    ...
		    yangFile = new YangFile(0, name, path, size, lastModifiedTime, fileContent, moduleName, modulePrefix, moduleNamespace, moduleRevisionString, moduleImports, moduleFeatures, templateFile);//Added file has always id=0
