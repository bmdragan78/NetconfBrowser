	...
	private final class FileWatcher extends Thread {
	  ...
	  public synchronized List<YangFile> getFileObjects() throws Exception{
		  ...
		  for (Path file: stream) {
		      ...
		      YangFile yangFile = new YangFile(rand.nextInt(Integer.MAX_VALUE/1000), name, path, size, lastModifiedTime, fileContent, moduleName, modulePrefix, moduleNamespace, moduleRevisionString, moduleImports, moduleFeatures, file);
