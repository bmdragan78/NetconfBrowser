...
public class YangDataSchemaNode extends YangSchemaNode{
	...
	public YangDataSchemaNode(NotificationDefinition notifOD, String xpath, ModuleIdentifier moduleId) {//??????? called only once for Yang Notification
		super(notifOD, xpath, moduleId);
		
		notifOD.getMustConstraints();
		
//		List<TypeDefinition<? extends TypeDefinition<?>>> typeList = schemaNode.getTypeList();
//	    TypeDefinition type = typeList.get(0);
	    
	    
//	    Collection<? extends TypeDefinition<?>> typeList = notifOD.getTypeDefinitions();
//	    TypeDefinition type = (TypeDefinition) (new ArrayList(typeList)).get(0);
//
...
//		}
	...
	public YangDataSchemaNode(AugmentationSchemaNode augOD, ModuleIdentifier moduleId) {
