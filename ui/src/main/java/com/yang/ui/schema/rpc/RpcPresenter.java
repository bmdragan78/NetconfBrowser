package com.yang.ui.schema.rpc;
...
public class RpcPresenter  implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle rb) {
    	rpcPane.getStyleClass().add("gridPane");
    }
    
	
	public void updateView(SchemaItem selSchemaItem) {
		YangRpc yangNode = (YangRpc) selSchemaItem.getSchemaNode();
