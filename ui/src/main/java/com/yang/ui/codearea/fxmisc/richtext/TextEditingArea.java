...
public interface TextEditingArea<PS, SEG, S> {
    ...
    /**
     * See {@link com.yang.ui.codearea.fxmisc.richtext.model.EditableStyledDocument#multiPlainChanges()}
     */
    EventStream<List<PlainTextChange>> multiPlainChanges();

    /**
     * See {@link com.yang.ui.codearea.fxmisc.richtext.model.EditableStyledDocument#plainChanges()}
     */
    EventStream<PlainTextChange> plainTextChanges();

    /**
     * See {@link com.yang.ui.codearea.fxmisc.richtext.model.EditableStyledDocument#multiRichChanges()}
     */
    EventStream<List<RichTextChange<PS, SEG, S>>> multiRichChanges();

    /**
     * See {@link com.yang.ui.codearea.fxmisc.richtext.model.EditableStyledDocument#richChanges()}
     */
