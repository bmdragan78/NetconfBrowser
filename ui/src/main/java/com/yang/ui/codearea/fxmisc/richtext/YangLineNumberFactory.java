 ...
 */
public class YangLineNumberFactory<PS> implements IntFunction<Node> {
    ...
    public static <PS> IntFunction<Node> get(
        ...
        return new YangLineNumberFactory<>( area, format, isFolded, removeFoldStyle );
    }
