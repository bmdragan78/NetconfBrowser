 ...
 */
package com.yang.ui.afterburner.configuration;
...
public class Configurator {
	...
	//modified by US in order to load all properties from a single configuration file located in root instead of multiple ones located in component packages
    //public final static String CONFIGURATION_FILE = "/resources/application.properties";
	public final static String CONFIGURATION_FILE = "/application.properties";
