package com.yangui.main.multiquery.query.unlockop;
...
public class UnlockopPresenter extends BaseopPresenter implements Initializable {
	...
	protected void selectTargetAction(ActionEvent event) {
		...
		if(queryTypeEnum.equals(QueryTypeEnum.UNLOCK)) {
