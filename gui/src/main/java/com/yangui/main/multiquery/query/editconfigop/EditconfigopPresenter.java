package com.yangui.main.multiquery.query.editconfigop;
...
public class EditconfigopPresenter extends BaseopPresenter implements Initializable {
	...
	protected void selectTargetAction(ActionEvent event) {
	    String source = targetCmb.getSelectionModel().getSelectedItem().toString();
		...
		if(queryTypeEnum.equals(QueryTypeEnum.EDIT_CONFIG)) {
			targetService.setData(source, input, queryName);
