package com.yangui.main.multiquery.query.deleteconfigop;
...
public class DeleteconfigopPresenter extends BaseopPresenter implements Initializable {
	...
	protected void selectTargetAction(ActionEvent event) {
		...
		if(queryTypeEnum.equals(QueryTypeEnum.DELETE_CONFIG)) {
