...
//		return true;
	...
	public YangModule(String name, String namespace, String prefix, String revision, String organization, String contact, String description, boolean isDataContainer, Set<ModuleImport>  moduleImports) {
		super();
		this.name = name;
